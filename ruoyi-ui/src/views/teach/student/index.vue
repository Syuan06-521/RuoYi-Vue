<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="准考证号" prop="confirmCard">
        <el-input
          v-model="queryParams.confirmCard"
          placeholder="请输入准考证号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="政治面貌" align="center" prop="stuPoliStatus" />
      <el-table-column label="准考证号" align="center" prop="confirmCard" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="性别" prop="stuGender">
          <el-input v-model="form.stuGender" placeholder="请输入性别" />
        </el-form-item>
        <el-form-item label="年龄" prop="stuAge">
          <el-input v-model="form.stuAge" placeholder="请输入年龄" />
        </el-form-item>
        <el-form-item label="政治面貌" prop="confirmCard">
          <el-input v-model="form.stuPoliStatus" placeholder="请输入政治面貌" />
        </el-form-item>
        <el-form-item label="准考证号" prop="confirmCard">
          <el-input v-model="form.confirmCard" placeholder="请输入准考证号" />
        </el-form-item>
